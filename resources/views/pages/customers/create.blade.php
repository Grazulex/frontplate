...
@section('workspace')
    ...
    <div class="card p-5">
        <div class="text-xl">Customers - Create</div>
        ...
        <form action="{{ route('customers.store') }}" method="POST" enctype="multipart/form-data" class="relative mt-5">
            ...
            <div class="flex mb-2">
                ...
                <div class="w-1/2 mr-2">
                    ...
                    <input value="{{ old('enum_ref') }}" id="enum_ref" name="enum_ref" type="text" class="form-control" placeholder="Enter the technical enum ref">
                </div>
            </div>
            <div class="flex mb-2">
                <div class="w-full">
